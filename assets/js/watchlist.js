...
function rate_and_remove1(e) {
  ...
  // console.log(1);
  temp_database_after_watched.push([to_rate_and_remove_html, 1]);
...
function rate_and_remove2(e) {
  ...
  // console.log(2);
  temp_database_after_watched.push([to_rate_and_remove_html, 2]);
  to_rate_and_remove.remove();
  console.log(temp_database_after_watched);
}
...
function rate_and_remove3(e) {
  ...
  // console.log(3);
  temp_database_after_watched.push([to_rate_and_remove_html, 3]);
  to_rate_and_remove.remove();
  console.log(temp_database_after_watched);
}
...
function rate_and_remove4(e) {
  ...
  // console.log(to_rate_and_remove_html);
  for (let i = 0; i < temp_database_to_remove.length; i++) {
    if (to_rate_and_remove_html == temp_database[i][0]) {
      temp_database.splice(i, 1);
      // console.log(temp_database);
  ...
  // console.log(4);
  temp_database_after_watched.push([to_rate_and_remove_html, 4]);
  to_rate_and_remove.remove();
  console.log(temp_database_after_watched);
}
...
function rate_and_remove5(e) {
  ...
  // console.log(5);
  temp_database_after_watched.push([to_rate_and_remove_html, 5]);
  to_rate_and_remove.remove();
  console.log(temp_database_after_watched);
}
